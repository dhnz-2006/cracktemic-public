...
migrate = Migrate()
app.config['SQLALCHEMY_DATABASE_URI']='postgresql://postgresql:E4LsitsLd6VZvRek2TC5uLQ2pWBaURzI@dpg-cnpknmgl5elc73cnl0cg-a.oregon-postgres.render.com/postgresql_in6a'
